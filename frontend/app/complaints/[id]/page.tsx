...
export default function ComplaintDetailPage() {
  ...
  const getStatusBadge = (status: string) => {
    ...
    return (
      <span
        className={`inline-flex items-center gap-2 px-4 py-2 rounded-full ${badge.bg} ${badge.text} font-semibold`}
      >
  ...
  const getPriorityBadge = (priority: string) => {
    ...
    return (
      <span
        className={`inline-flex items-center px-3 py-1 rounded-full ${badge.bg} ${badge.text} text-sm font-semibold`}
      >
  ...
  const handleSendEmail = () => {
    if (user?.emailid) {
      const subject = encodeURIComponent(
        `Regarding Complaint ${complaint?.caseId}`
      );
      ...
      <div className="space-y-6">
        ...
        <div className="hidden print:block text-center mb-6">
          <h1 className="text-2xl font-bold">
            SurakshaBot - 1930 Cyber Helpline, India
          </h1>
        ...
        <div className="hidden print:block mb-4">
          ...
          <p className="text-sm">
            Status: {complaint.status} | Priority:{" "}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
                ...
                <div className="space-y-4">
                  {[...complaint.statusHistory]
                    ...
                    .map((history: any, index: number) => (
                      <div
                        key={index}
                        className="flex gap-4 p-4 bg-gray-50 rounded-lg border-l-4 border-primary"
                      >
            ...
            {/* Evidence/Photos */}
            {complaint.caseDetailsId?.photos &&
              complaint.caseDetailsId.photos.length > 0 && (
                <div className="card print:page-break-before">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-4 print:grid-cols-2 print:gap-6">
                    {complaint.caseDetailsId.photos.map(
                      (photo: any, index: number) => (
                        ...
                        >
                          {photo.url ? (
                            ...
                            <div className="w-full h-48 bg-gray-200 rounded-lg border-2 border-gray-300 flex items-center justify-center">
